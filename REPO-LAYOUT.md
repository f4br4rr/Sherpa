...
| [PHASE-READINESS.md](PHASE-READINESS.md) | **Phase readiness (Phases 1–6):** exit criteria per phase, dependencies, **Handoff to Phase 2** (corpus contract). Architecture doc remains canonical. |
