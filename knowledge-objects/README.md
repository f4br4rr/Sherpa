...
- **Mac corpus:** Phase 1 articles under **`corpus/mac/`** are **Apple Silicon–oriented**; use **`configuration_item`** values like **`macOS (Apple Silicon)`** so `getCategory` / filters stay consistent — see architecture doc.
